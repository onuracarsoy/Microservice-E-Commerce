...
{
    public class IdentityForAdminService : IIdentityForAdminService
    {
        ...
        public IdentityForAdminService(HttpClient httpClient, IHttpContextAccessor contextAccessor, IOptions<ClientSettings> clientSettings, IOptions<ServiceApiSettings> serviceApiSettings)
        {
        ...
        public async Task<bool> GetRefreshToken()
        {
            ...
            {
                ClientId = _clientSettings.ShopAdminClient.ClientID,
                ClientSecret = _clientSettings.ShopAdminClient.ClientSecret,
